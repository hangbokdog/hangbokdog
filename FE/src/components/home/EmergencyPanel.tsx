...
export default function EmergencyPanel() {
    ...
    const movingList = [
        { name: "서현", startLocation: "서울", endLocation: "인천공항", date: "D-10시간", index: 0 },
        { name: "도넛", startLocation: "부산", endLocation: "대구", date: "D-2일", index: 1 },
    ];

    const volunteerList = [
        { title: "이삿짐 옮기기", current: 2, target: 5, date: "D-1일", index: 0 },
        { title: "고양이 돌보기", current: 1, target: 2, date: "D-3일", index: 1 },
    ];

    const donationList = [
        { title: "수술비 지원", current: 30, target: 100, date: "D-5일", index: 0 },
        { title: "월세 지원", current: 70, target: 100, date: "D-2일", index: 1 },
    ];
